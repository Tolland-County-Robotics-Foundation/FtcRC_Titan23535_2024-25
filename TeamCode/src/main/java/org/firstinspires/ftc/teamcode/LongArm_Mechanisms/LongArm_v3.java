...
public class LongArm_v3 {
    ...
    public void autoLiftArm()
    {
        ...
        int liftTargetLeft = leftArmLift.getCurrentPosition() + (int) (LIFT_DISTANCE * COUNTS_PER_INCH);
        int liftTargetRight = rightArmLift.getCurrentPosition() - (int) (LIFT_DISTANCE * COUNTS_PER_INCH);

        leftArmLift.setTargetPosition(liftTargetLeft);
        rightArmLift.setTargetPosition(liftTargetRight);
